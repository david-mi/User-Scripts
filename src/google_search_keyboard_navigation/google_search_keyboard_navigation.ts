(function () {
  ...
  function getLinks() {
    return Array
      .from(document.querySelectorAll<HTMLLinkElement>("a:has(h3)"))
  ...
  function getLinkToFocusIndex(directionKey: "ArrowUp" | "ArrowDown") {
  ...
  let links = getLinks()
  let linkToFocusIndex: null | number = null
